...
If you create a mocking error, one of the following two parameters provide the trigger for the error in the *Then-return* tab:

- *TypeId*: It follows a Mule Error type definition. For example, the HTTP:CONNECTIVITY error explained before <2>.
