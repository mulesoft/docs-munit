...
The SAP connector requires a set of specific libraries which are listed in the xref:3.8@mule-runtime::sap-connector.adoc#requirements[SAP Connector requirements] documentation. These libraries need to be added manually in order to test the SAP-based application correctly.
...
[TIP]
--
This process is also described in the xref:3.8@mule-runtime::sap-connector-troubleshooting.adoc#solution[SAP Connector documentation].
--
+
