...
The domain is a mavenizable artifact and you can https://docs.mulesoft.com/mule-user-guide/v/3.8/enabling-maven-support-for-a-studio-project#mavenizing-an-existing-mule-project[mavenize it directly from Studio]. +
