...
The domain is a mavenizable artifact and you can xref:6@studio::enabling-maven-support-for-a-studio-project.adoc#mavenizing-an-existing-mule-project[mavenize it directly from Studio]. +
