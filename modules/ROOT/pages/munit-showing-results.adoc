...
MUnit console logs report test results in three states: successful build, failed build, and build error. Use the MUnit Run Summary at the end of each run to quickly identify the number of tests, failures, errors, and skipped tests.
