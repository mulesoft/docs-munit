...
[NOTE]
--
Since version 1.2.0, MUnit supports xref:munit-domain-support.adoc[testing for domain based applications].
--
...
You can run xref:munit-coverage-report.adoc[coverage reports] in Studio.
