...
You can debug MUnit tests just like Studio applications, using Studio debugging perspective (for details on the debugging UI, see xref:studio::visual-debugger-concept.adoc[Studio Visual Debugger]).
