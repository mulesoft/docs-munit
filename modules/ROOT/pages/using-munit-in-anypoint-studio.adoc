...
You can debug MUnit tests just like Studio applications, using Studio debugging perspective (for details on the debugging UI, see xref:6.x@studio::studio-visual-debugger.adoc[Studio Visual Debugger]).
