= MUnit Assert Expression Processor
...
The MUnit Assert Expression processor evaluates DataWeave expressions to validate a Mule event's content during a MUnit test, using the DataWeave Assertions Library. Use it when you need DataWeave-native assertions or want to create custom matchers with the DataWeave Assertions Library.
