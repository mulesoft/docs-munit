= Install the MUnit Database Server Module
...
Install the MUnit Database Server module to run MUnit tests against an in-memory H2 database without an external database server. This makes your Maven project portable and your database tests isolated and repeatable.
...
[[db-structure-sql]]
=== Define the DB Structure from an SQL File
