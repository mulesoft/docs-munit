...
[NOTE]
The *MuleSoft DB Server* module is located at https://repository.mulesoft.org/nexus/content/repositories/releases/com/mulesoft/munit/utils/munit-dbserver-module/[MuleSoft Nexus repository]. Previous versions of this module available at Anypoint Exchange are deprecated.
