...
[NOTE]
The *MUnit DB Server* module is located at https://repository.mulesoft.org/nexus/content/repositories/releases/com/mulesoft/munit/utils/munit-dbserver-module/[MuleSoft Nexus repository]. The *MUnit DB Server* module version 3 and later are compatible with Java 17. Previous versions of this module available at Anypoint Exchange are deprecated.
