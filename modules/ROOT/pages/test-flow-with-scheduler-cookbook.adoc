= Test a Flow with a Scheduler Source in MUnit
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]
:page-deployment-options: acb-ide, studio-ide

Test a Mule flow triggered by a Scheduler component in MUnit by enabling flow sources and using the verify-call processor to confirm the flow executes. Wrap verify-call inside an until-successful scope to handle timing variations in the Scheduler.
