...
[NOTE]
--
The Scaffolder that generates the MUnit test from the RAML definition does not consider if your application uses xref:3.8@mule-runtime::tls-configuration.adoc[TLS configuration]. +
