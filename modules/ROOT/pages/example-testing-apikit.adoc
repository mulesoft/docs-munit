...
You can use APIkit in Mule runtime with or without API Gateway. API Gateway Runtime 1.3 - 2.x has a https://docs.mulesoft.com/api-manager/api-gateway-domain[mule domain named api-gateway].
