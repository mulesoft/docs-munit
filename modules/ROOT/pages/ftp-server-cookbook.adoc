...
To install the FTP server, you must:

. Look for the *MUnit Utils FTP Server* asset in Exchange.
...
To define the FTP server, you must change the FTP server attributes as follows:
