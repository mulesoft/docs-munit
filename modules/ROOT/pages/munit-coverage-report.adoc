...
The MUnit Coverage feature measures how much of a Mule application is executed by a set of MUnit tests by counting event processors. Use it to track application, resource, and flow coverage metrics and enforce quality standards.
