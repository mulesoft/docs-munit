...
The MUnit Coverage Module unit of measure is the xref:3.8@mule-runtime::index.adoc#message-processors[message processor]. +
...
For example, using a ´processor-chain´ component (deprecated since Mule 3.2), in a xref:3.8@mule-runtime::routers.adoc#first-successful[first successful] router displays only two from the three message processors that MUnit considers to calculate coverage:
