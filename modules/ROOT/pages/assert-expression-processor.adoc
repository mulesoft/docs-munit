= About Assert Expression Event Processor
...
This Event Processor can be used to validate the Mule Event after the production code runs, using the xref:weave-assertions.adoc[DW Assertions Library]
