...
An MUnit test suite is an XML file that contains MUnit tests organized into behavior, execution, and validation scopes. Use test suite files in the src/test/munit directory to define, configure, and run automated tests against your Mule application flows.
