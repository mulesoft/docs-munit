...
To specify that a suite should run with a required Mule product, you can use the
`requiredProduct` attribute of the configuration.

[source,xml]
----
<munit:config name="A MUnit Suite" requiredProduct="MULE_EE"/>
----
