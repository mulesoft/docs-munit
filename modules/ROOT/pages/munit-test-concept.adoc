...
You can add the attribute expectedErrorType and expectedException, as shown below:
...
* The attribute expectedException expects a literal exception class name (canonical form).
