...
The base file in MUnit is the test suite file, an XML file located in the `src/test/munit` directory of your Mule application project. You can have as many MUnit test suite files as needed. Each MUnit test suite file is a collection of MUnit tests and runs independently from other MUnit test suites.
