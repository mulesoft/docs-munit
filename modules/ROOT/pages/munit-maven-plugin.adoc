...
== Enabling Sonar Reports

MUnit has built-in support for SonarQube. No additional configuration is needed, but you can disable it if you don't need it:

.Disabling sonar reports
[source]
----
