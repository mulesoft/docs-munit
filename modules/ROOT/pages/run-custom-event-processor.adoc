= MUnit Run Custom Event Processor
...
The MUnit Run Custom event processor runs a custom Java assertion class against a Mule event during a MUnit test. Use it when built-in matchers are not sufficient and you need to implement custom validation logic in Java.
