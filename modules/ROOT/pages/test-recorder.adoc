...
The following table describes the product versions required to use the test recorder. These versions are for the beta feature and are likely to change for the GA (general availability) release.
