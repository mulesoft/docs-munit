...
| Mule runtime engine
| Patched version of 4.2.2. +
See xref:runtime-patching.adoc[Patching the Embedded Mule Runtime Engine Version] to learn how to apply this patched version to your project.
