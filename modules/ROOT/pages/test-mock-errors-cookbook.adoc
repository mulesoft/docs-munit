= Test and Mock Errors in MUnit
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]
:page-deployment-options: acb-ide, studio-ide

Test and mock error handling in MUnit by configuring expected error types, using mock-when to simulate errors, or setting errors directly on the Mule event. Use these techniques to validate on-error-continue and on-error-propagate scopes in your flows.
