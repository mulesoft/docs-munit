...
application XML file. You can use several of the Mule top level elements such as xref:3.9@mule-runtime::flows-and-subflows.adoc[flow, sub-flow], xref:3.8@mule-management-console::automating-tasks-using-scripts.adoc[scripts], etc.
