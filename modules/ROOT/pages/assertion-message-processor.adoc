...
All the message processors listed bellow can be used either to validate the Mule message after the production code runs, or as part of the MUnit xref:spy-message-processor.adoc[Spy message processor].
