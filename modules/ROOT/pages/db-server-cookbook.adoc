...
Depending on the IDE you use, to install the MUnit Utils Database Server you must:

. Look for the *MUnit Utils Database Server* module:
.. In Anypoint Code Builder, open the Command Palette, look for *MuleSoft: Search in Exchange*, and type *MUnit Utils Database Server*.
.. In Anypoint Studio, go to the *Mule Palette* view, click *Search in Exchange*, and look for *MUnit Utils Database Server*. 
