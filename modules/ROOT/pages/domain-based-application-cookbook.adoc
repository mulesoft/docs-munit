= Test MUnit Domain-Based Applications
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]
:page-deployment-options: studio-ide

Test Mule applications that share resources with a Mule domain using MUnit, without additional configuration. Follow a step-by-step example using a domain-based HTTP listener application to see how MUnit resolves shared global configurations automatically.
...
== Write an MUnit Test for a Domain-Based Application
