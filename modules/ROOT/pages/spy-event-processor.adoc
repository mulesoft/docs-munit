...
You can configure the spy processor to spy any HTTP Listener and assert that the payload is null before reaching the component, and not null after it's been processed:
...
** xref:event-processors.adoc[About MUnit Event Processors]
