...
TIP: If you wish to set the payload to be a Spring bean, you can make use of the MUnit MEL function `getBeanFromMuleContext('bean_name')`. See xref:assertion-message-processor.adoc[Assertion] for details.
...
image::set-null-payload-munit.png[]
