= Test MUnit Processors That Use Target Variables
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]
:page-deployment-options: acb-ide, studio-ide

When testing a processor that stores its result in a target variable in MUnit, assert the content of the stored variable rather than the payload. If you mock the processor, define the target variable value in the mock configuration.
