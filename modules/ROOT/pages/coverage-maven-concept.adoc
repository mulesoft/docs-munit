...
* The *SONAR* report shows the same information in a format that SonarQube can use to inform coverage. To access the Sonar report locate the `${application.path}/target/site/munit/coverage/sonar.xml`
