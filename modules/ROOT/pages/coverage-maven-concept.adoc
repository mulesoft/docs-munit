...
The HTML report is available in the `${application.path}/target/site/munit/coverage/` path.
* The JSON report shows the same information as the HTML report, in a JSON format. +
The JSON report is availabie in `${application.path}/target/site/munit/coverage/munit-coverage.json` path.
* The SONAR report shows the same information as the HTML report, in a SonarQube format. +
The Sonar report is available in `${application.path}/target/site/munit/coverage/sonar.xml`.
