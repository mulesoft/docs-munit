= Use Utility Classes in MUnit Tests
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]
:page-deployment-options: acb-ide, studio-ide

Use custom Java utility classes located in `src/test/java` in your MUnit tests through DataWeave or the Java Module. Export the class package in your `mule-artifact.json` file to make it available during test execution.
