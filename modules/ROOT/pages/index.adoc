...
See the https://docs.mulesoft.com/release-notes/munit-1.1.1-release-notes[Release Notes] to see what's new.

[WARNING]
MUnit 1.1.x works with Mule versions 3.6.x and 3.7.x (for 3.6.x minor limitations, see https://docs.mulesoft.com/release-notes/munit-1.1.1-release-notes#compatibility-information[MUnit Release Notes - Compatibility Information]).
...
* xref:munit-1.1-migration-guide.adoc[MUnit 1.0 Migration Guide]