...
See the https://docs.mulesoft.com/release-notes/munit-1.2.1-release-notes[Release Notes] to see what's new.

TIP: MUnit version 1.2 works with all Mule versions since 3.6.0  (for 3.6.x minor limitations, see https://docs.mulesoft.com/release-notes/munit-1.2.1-release-notes#migration-guidance[MUnit Release Notes - Compatibility Information]).
