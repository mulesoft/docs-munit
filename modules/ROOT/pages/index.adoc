...
MUnit is fully integrated with Anypoint Studio, allowing you to create, design and run MUnit tests just like you would Mule applications. You can also use Anypoint Studio xref:studio::visual-debugger-concept.adoc[Studio Visual Debugger] to debug your MUnit tests.
