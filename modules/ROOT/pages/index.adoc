...
MUnit is integrated with Anypoint Studio and Anypoint Code Builder. You can create, design, and run MUnit tests just like you would Mule applications.

MUnit is divided into two main sub modules:
