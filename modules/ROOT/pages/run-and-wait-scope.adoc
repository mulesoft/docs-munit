...
If you choose to xref:6@studio::enabling-maven-support-for-a-studio-project.adoc[mavenize] your project, Studio will notify you that the Synchronize module dependency will be added.
