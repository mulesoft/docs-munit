...
TIP: If you are using Anypoint Studio, Maven integration is already solved for you. See xref:6@studio::using-maven-in-anypoint-studio.adoc[Using Maven in Anypoint Studio] for details.
