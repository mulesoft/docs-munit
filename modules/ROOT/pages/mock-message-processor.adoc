...
NOTE: You cannot mock flow control message processors, such as Filter or Choice. +
Additionally, you cannot mock the Validation module.
...
image::mock-processor-code-to-test.png[]
...
image::mock-when-message-processor-attributes.png[]
...
image::complex-mule-flow-example.png[]
...
image::mock-when-flow-test-sample.png[]
...
image::mock-when-match-contains.png[]
...
image::mock-then-return-real-payload.png[]
...
image::mock-return-same-payload.png[]
...
image::mock-message-property-return-same-payload.png[]
...
|Loads a resource from the project's classpath and returns an MuniResource object. This object supports util methods such as: `asStream()` , `asReusableStream()`, `asString()` and `asByteArray()`
...
----
* Return the content of users.xml as an input stream that can be read multiple times.
...
image::mock-match-script-result.png[]
...
image::mock-define-properties.png[]
...
image::mock-throw-an-attribute.png[]
