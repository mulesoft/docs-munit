...
You can click on *Generate Report* to get the report that details the flows and event processors in the Mule configuration files that are included in the MUnit test.
...
| *Weight*      | The percentage of your application in a configuration file. +
                ...
                amount of event processors in the Mule configuration file.
