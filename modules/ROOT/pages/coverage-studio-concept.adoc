...
You can exclude one or more XML files from an MUnit Coverage report when testing your application to get an overall coverage of 100%. 

. Go to the flow you want to have 100% coverage.
...
The coverage report notifies of 100%.
