= Run MUnit Coverage Reports in Anypoint Studio
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]
:page-deployment-options: studio-ide

Run MUnit coverage reports in Anypoint Studio to see which flows and event processors your tests cover. These configurations apply only when running MUnit tests in Studio, not from Maven in a CI/CD environment.
