...
| *Coverage*    | The percentage of event processors in the Mule configuration file that the MUnit test executes
|===
...
+
. Enter the name of the XML file to exclude from the Coverage report.
. Click *OK*.
. Click *Apply*.
. Click *Run*.
