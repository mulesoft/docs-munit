= MUnit Parameterized Test Suites
...
MUnit parameterized test suites run the same tests multiple times with different input values, reducing duplication in your test code. Define parameterizations inline in the test suite configuration or load them from a YAML file in your project's test resources.
